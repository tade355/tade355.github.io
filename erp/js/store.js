...
function seedData() {
  ...
  return {
    ...
    inventory: [
      { id: 'INV-1', name: 'CAT D6 Bulldozer', category: 'Heavy Equipment', sku: 'EQP-BD-01', quantity: 2, unit: 'unit', unitCost: 45000000, reorderLevel: 1, location: 'Main Yard' },
      { id: 'INV-2', name: 'Hydraulic Excavator 320D', category: 'Heavy Equipment', sku: 'EQP-EX-02', quantity: 3, unit: 'unit', unitCost: 38000000, reorderLevel: 1, location: 'Main Yard' },
      { id: 'INV-3', name: 'Diesel (AGO)', category: 'Consumables', sku: 'FUEL-001', quantity: 1200, unit: 'litres', unitCost: 1150, reorderLevel: 2000, location: 'Fuel Depot' },
      { id: 'INV-4', name: 'Chainsaw - Stihl MS 660', category: 'Tools', sku: 'TL-CHS-05', quantity: 8, unit: 'unit', unitCost: 320000, reorderLevel: 3, location: 'Tool Store' },
      { id: 'INV-5', name: 'Hydraulic Oil', category: 'Consumables', sku: 'LUB-011', quantity: 40, unit: 'drums', unitCost: 65000, reorderLevel: 15, location: 'Fuel Depot' },
      { id: 'INV-6', name: 'Safety Helmets', category: 'Safety Gear', sku: 'PPE-HLM-01', quantity: 25, unit: 'unit', unitCost: 4500, reorderLevel: 10, location: 'Tool Store' },
      { id: 'INV-7', name: 'Tipper Truck', category: 'Heavy Equipment', sku: 'EQP-TT-03', quantity: 1, unit: 'unit', unitCost: 28000000, reorderLevel: 1, location: 'Main Yard' },
    ],
    customers: [
    ...
    operations: [
      { id: 'OPS-1', date: iso(6), siteName: 'Greenview Estates - Phase 2', customerId: 'CUS-1', equipment: 'CAT D6 Bulldozer', operatorId: 'EMP-4', supervisorId: 'EMP-1', hoursWorked: 8, areaCleared: 2.5, fuelUsed: 220, status: 'Completed', notes: 'Cleared northern block, no incidents.' },
      { id: 'OPS-2', date: iso(5), siteName: 'FHA Abuja Site B', customerId: 'CUS-3', equipment: 'Hydraulic Excavator 320D', operatorId: 'EMP-2', supervisorId: 'EMP-1', hoursWorked: 9, areaCleared: 3.1, fuelUsed: 260, status: 'Completed', notes: 'Encountered rocky terrain, slight delay.' },
      { id: 'OPS-3', date: iso(4), siteName: 'Sunrise Agro Farms', customerId: 'CUS-2', equipment: 'CAT D6 Bulldozer', operatorId: 'EMP-4', supervisorId: 'EMP-1', hoursWorked: 7, areaCleared: 2.0, fuelUsed: 195, status: 'Completed', notes: '' },
      { id: 'OPS-4', date: iso(2), siteName: 'Delta Oil Services Row', customerId: 'CUS-4', equipment: 'Hydraulic Excavator 320D', operatorId: 'EMP-2', supervisorId: 'EMP-5', hoursWorked: 6, areaCleared: 1.6, fuelUsed: 150, status: 'Ongoing', notes: 'Continuing tomorrow.' },
      { id: 'OPS-5', date: iso(1), siteName: 'Greenview Estates - Phase 2', customerId: 'CUS-1', equipment: 'Tipper Truck', operatorId: 'EMP-4', supervisorId: 'EMP-1', hoursWorked: 5, areaCleared: 1.2, fuelUsed: 110, status: 'Halted', notes: 'Halted due to rainfall.' },
    ],
  };
}
